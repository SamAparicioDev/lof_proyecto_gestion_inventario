 ...
 *
 * El puerto `ModeloConversacional` se cablea al adaptador de Claude; sustituirlo por otro
...
import { AdaptadorClaude } from '../../../infraestructura/ia/adaptador-claude';
...
@Module({
  ...
  providers: [
    ...
    { provide: MODELO_CONVERSACIONAL, useClass: AdaptadorClaude },
    {
